...
$mail->FromName = "Pedido de Data Center"; // Nome da conta de email
 
// DADOS DO DESTINATÁRIO
$mail->AddAddress('i.oliveira@objetiveti.com.br', 'Site - Pedido'); // Define qual conta de email receberá a mensagem
...
$mail->Subject  = "Pedido de Data Center"; // Assunto da mensagem
...
$mail->Body .= " Plano: ".nl2br($_POST['plano'])."<br>"; // Texto da mensagem
...
?>
    ...
    <script>
        setTimeout(function(){
            window.location.href = 'https://objetiveti.com.br/data-center.php';
        }, 3000);
    </script>
<?php
} else {
