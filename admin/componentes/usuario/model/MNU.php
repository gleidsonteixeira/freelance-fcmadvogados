...
class MNU{   
   ...
   public function listar_menu_ativo_tipo($EMP_COD) {
      $lista_menu = array(); 
      try{
         $sql = "SELECT MNU.* FROM MNU, EMP WHERE MNU.MNU_STATUS = 1 AND MNU.MNU_TIPO = EMP.EMP_TIPO AND EMP.EMP_COD = $EMP_COD;";
