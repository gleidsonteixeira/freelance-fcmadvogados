<?php
	...
	$menu = new MNU();
    $mnu = $menu->listar_menu_admin($_SESSION['C_USU_TIPO'], $_SESSION['C_USU_COD']); 
?>

<!DOCTYPE html>
<html>
<head>
	<title>Cliente | Objetive TI</title>
...
<body>
	<div class="menu">
		...
		<ul class="nm">
			...
			?>
						<li>
							<h6 class="mini-title upper click" onClick='carregarConteudo("<?php echo $menu_categoria;?>")'><?php echo $row_ctm["CTM_NOME"]; ?></h6>
							<ul>
						<?php 
							$o = 0;
							while (count($mnu["LISTA_MENU"]) > $o) {
						...
						?>
									<li>
										<h6 class="mini-title upper click" onClick='carregarConteudo("<?php echo $row_mnu["MNU_COMPONENTE"];?>")'><?php echo $row_mnu["MNU_NOME"]; ?></h6>
									</li>
						<?php
								}
								$o++;
	...
	<script>
		...
		menu_inicial = "componentes/chamados"
