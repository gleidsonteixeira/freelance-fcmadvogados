<div id="usuario-componente" class="usuario-componente">
    <div class="box dados empresa hide">
    <div class="box-head">
    ...
    <div class="box suave">
        <div class="box-head">
            ...
            <div class="box-actions suave">
                <button class="cta left suave mini-title upper novo-usuario">novo Usuário</button>
            </div>
    ...
    <div id="gaveta" class="suave">
        ...
        <form id="novoUsuario" class="suave novoUsuario" enctype="multipart/form-data">
        ...
        <form id="editUsuario" class="suave editUsuario" enctype="multipart/form-data">
