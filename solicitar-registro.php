...
$mail->Subject  = "Solicitação de pesquisa[".nl2br($_POST['marca'])."]"; // Assunto da mensagem
...
$mail->Body .=  '        <h2 style="color: #56aeff;">Solicitação de pesquisa</h2>';
...
$mail->Body .=  '        <h4 style="margin-bottom: 0;font-weight:bold;color: #1b5678;">Marca:</h4>';
$mail->Body .=  '        <p style="margin: 0;font-size: 18px;">'.nl2br($_POST['marca']).'</p>';
$mail->Body .=  '        <h4 style="margin-bottom: 0;font-weight:bold;color: #1b5678;">Ramo:</h4>';
$mail->Body .=  '        <p style="margin: 0;font-size: 18px;">'.nl2br($_POST['ramo']).'</p>';
$mail->Body .=  '    </div>';
$mail->Body .=  '</div>';
...
?>
    <div class="obrigado">
        ...
        <h5 class="font cor1-text">Solicitação enviada,<br>Responderemos o mais rápido possível!</h5>
